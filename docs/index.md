...
- **Crafting:** along the game, there is a lot of loot that we will be able to get and it to craft useful things like the ammo. So we will be exploring all of the environment in search of materials for craft.
- **Story:** Last of Us is a game based on narrative. The story that the game tells us is one of the most important things when we play the game.
